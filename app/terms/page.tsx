    ...
    <div style={{
      ...
      <div style={{
        ...
        >
          ...
          <Section title="1. 서비스의 소개 및 이용 방식">
          ...
          <Section title="2. 결제 및 환불 정책">
            ...
            <h4 style={{ color: '#FFFFFF', fontWeight: '700', marginTop: '1.5rem', marginBottom: '1rem' }}>강의 환불 규정</h4>

            <h5 style={{ color: '#FFFFFF', fontWeight: '600', marginTop: '1rem', marginBottom: '0.75rem' }}>제 1조 (목적)</h5>
            <p style={{ marginBottom: '1rem' }}>
              본 규정은 박교준 입시연구소(이하 "회사")의 교습비 반환에 관한 사항을 규정함을 목적으로 하며, 학원의 설립ㆍ운영 및 과외교습에 관한 법률 시행령 [별표 4]의 교습비 반환 기준(제18조 제3항)을 준수합니다.
            </p>

            <h5 style={{ color: '#FFFFFF', fontWeight: '600', marginTop: '1rem', marginBottom: '0.75rem' }}>제 2조 (환불 신청 및 기준)</h5>
            
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>1. 기본 원칙</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>2. 수업 경과 기준</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>3. 강의 중 일시정지</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>4. 환불 제한 사항</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <h5 style={{ color: '#FFFFFF', fontWeight: '600', marginTop: '1rem', marginBottom: '0.75rem' }}>제 3조 (환불 금액 산정)</h5>
            
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>1. 기준 금액</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>2. 산정 기준</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <h5 style={{ color: '#FFFFFF', fontWeight: '600', marginTop: '1rem', marginBottom: '0.75rem' }}>제 4조 (환불 처리 기한 및 방식)</h5>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <h5 style={{ color: '#FFFFFF', fontWeight: '600', marginTop: '1rem', marginBottom: '0.75rem' }}>제 5조 (환불 불가 조건)</h5>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <h5 style={{ color: '#FFFFFF', fontWeight: '600', marginTop: '1rem', marginBottom: '0.75rem' }}>제 6조 (특수 상황 처리)</h5>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
            ...
            <h4 style={{ color: '#FFFFFF', fontWeight: '700', marginTop: '2rem', marginBottom: '1rem' }}>📦 교재 환불 규정</h4>
            
            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>교재 출고 전</p>
            <p style={{ marginBottom: '1rem' }}>출고 전일 경우, 박교준 입시연구소 카카오채널을 통해 환불 신청 시 전액 환불</p>

            <p style={{ fontWeight: '600', marginBottom: '0.5rem' }}>교재 출고 후</p>
            <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
