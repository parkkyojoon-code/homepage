...
const getClassDetail = (id: string): ClassDetail | null => {
  const classDetails: Record<string, ClassDetail> = {
    "1": {
      ...
      faqs: [
        {
          question: "수업을 못 들었을 경우 어떻게 하나요?",
          answer: "모든 수업은 녹화되어 제공되므로 언제든지 다시 보실 수 있습니다."
        },
        {
          question: "첨삭은 어떻게 진행되나요?",
          answer: "매주 작성한 답안을 제출하시면 72시간 이내에 상세한 첨삭 피드백을 제공합니다."
        }
      ],
      instructorInfo: {
        name: "박교준",
      ...
      faqs: [
        {
          ...
          answer: "구매 후 수능일까지 무제한 시청 가능하며, 이후에도 1년간 복습용으로 제공됩니다."
        }
      ],
      instructorInfo: {
        name: "박교준",
            ...
            {activeSection === 'reviews' && (
              ...
              >
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
                  {classDetail.reviews.map((review) => (
                    <motion.div
                      key={review.id}
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <div style={{
                      ...
                      {classDetail.instructorInfo.name[0]}
                    </div>
                    <div>
                      <h3 style={{ fontSize: '1.5rem', fontWeight: '700', marginBottom: '8px' }}>
                        {classDetail.instructorInfo.name}
                      </h3>
                      <p style={{
                        fontSize: '1.1rem',
                        color: 'rgba(255, 255, 255, 0.7)',
                        ...
                        {classDetail.instructorInfo.title}
                      </p>
                      <p style={{
                        fontSize: '1rem',
                        lineHeight: '1.6',
                        ...
                        {classDetail.instructorInfo.bio}
                      </p>
                      <div style={{
                        display: 'flex',
                        alignItems: 'center',
                        ...
                        <Award size={18} />
                        경력 {classDetail.instructorInfo.experience}
                      </div>
                    </div>
                  </div>
                  <div>
                    ...
                    <div style={{
                      ...
                      {classDetail.instructorInfo.achievements.map((achievement, index) => (
                        <div
                          key={index}
                          style={{
                            display: 'flex',
                        ...
                        >
                          <TrendingUp size={18} style={{ color: '#4CAF50', flexShrink: 0 }} />
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <Shield size={24} style={{ color: '#4CAF50', flexShrink: 0, marginTop: '2px' }} />
                    <div>
                      <h3 style={{
                        fontSize: '1.2rem',
                        fontWeight: '600',
                  ...
                  <div style={{
                    ...
                    <div>
                      <p style={{
                        ...
                        환불 요청은 마이페이지에서 직접 신청 가능하며, 영업일 기준 3-5일 이내 처리됩니다.
                      </p>
                    </div>
                  </div>
                </div>
