  ...
  return (
    <div style={{ minHeight: '100vh', padding: '0 0 80px' }}>
      <div style={{ maxWidth: 720, margin: '0 auto', padding: '36px 20px 0' }}>
        ...
        <h1 style={{ fontSize: 26, fontWeight: 800, color: '#fff', marginBottom: 6 }}>데이터 관리</h1>
        ...
        {/* 현재 파일 */}
        <div style={{ ...card, padding: '18px 22px', borderLeft: '3px solid rgba(0,102,255,0.5)', marginBottom: 20 }}>
        ...
        {/* 업로드 규칙 */}
        <div style={{ ...card, background: 'rgba(255,255,255,0.02)', padding: '18px 20px' }}>
